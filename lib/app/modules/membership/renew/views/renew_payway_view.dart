...
class RenewPayWayView extends StatefulWidget {
  final SubscriptionModel subscription;

  const RenewPayWayView({super.key, required this.subscription});

  @override
  State<RenewPayWayView> createState() => _RenewPayWayViewState();
}

class _RenewPayWayViewState extends State<RenewPayWayView> {

...
class JoinPayWayView extends StatefulWidget {
  const JoinPayWayView({super.key});

  @override
  State<JoinPayWayView> createState() => _JoinPayWayViewState();
}

class _JoinPayWayViewState extends State<JoinPayWayView> {
              ...
              if (snapshot.hasData) {
                return InAppWebView(
                  ...
                  initialUrlRequest: URLRequest(
                    url: WebUri('${ApiService.baseUrl}insurance/payway/join'),
                    headers: {

...
class EditAgencyView extends StatefulWidget {
  final AgencyModel agency;

  const EditAgencyView({super.key, required this.agency});

  @override
  State<EditAgencyView> createState() => _EditAgencyViewState();
}

class _EditAgencyViewState extends State<EditAgencyView>
    with AutomaticKeepAliveClientMixin<EditAgencyView> {
  ...
  void initState() {
    ...
    if (widget.agency.provinceId != null) {
      _getDistricts(widget.agency.provinceId);
    }
    if (widget.agency.districtId != null) {
      _getCommunes(widget.agency.districtId);
    }
    if (widget.agency.communeId != null) {
      _getVillages(widget.agency.communeId);
    }
    super.initState();
  }
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: Container(
            ...
            child: FormBuilder(
              key: _formKey,
              initialValue: widget.agency.toJson(),
                  ...
                  child: Column(
                    children: [
                      ...
                      FormBuilderImagePicker(
                        ...
                        placeholderImage:
                            widget.agency.profilePictureUrl != null
                                ? NetworkImage(widget.agency.profilePictureUrl!)
                                : null,
                      ),
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      FormBuilderDateTimePicker(
                        initialValue: widget.agency.dateOfBirth != null
                            ? DateTime.parse(widget.agency.dateOfBirth!)
                            : null,
                        name: 'date_of_birth',
                        ...
                        children: [
                          Expanded(
                            child: FormBuilderDateTimePicker(
                              initialValue: widget.agency.jointDate != null
                                  ? DateTime.parse(widget.agency.jointDate!)
                                  : null,
                              name: 'joint_date',
                              inputType: InputType.date,
                              decoration: InputDecoration(
                          ...
                          Expanded(
                            child: FormBuilderTextField(
                              initialValue: "${widget.agency.monthlyTarget}",
                              name: 'monthly_target',
                              keyboardType:
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                            child: FormBuilderDropdown(
                              initialValue: _provinces.firstWhereOrNull(
                                          (element) =>
                                              element['id'] ==
                                              widget.agency.provinceId) !=
                                      null
                                  ? widget.agency.provinceId
                                  : null,
                              name: 'province_id',
                          ...
                          Expanded(
                            child: FormBuilderDropdown(
                              initialValue: _districts.firstWhereOrNull(
                                          (element) =>
                                              element['id'] ==
                                              widget.agency.districtId) !=
                                      null
                                  ? widget.agency.districtId
                                  : null,
                              name: 'district_id',
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                            child: FormBuilderDropdown(
                              initialValue: _communes.firstWhereOrNull(
                                          (element) =>
                                              element['id'] ==
                                              widget.agency.communeId) !=
                                      null
                                  ? widget.agency.communeId
                                  : null,
                              name: 'commune_id',
                          ...
                          Expanded(
                            child: FormBuilderDropdown(
                              initialValue: _villages.firstWhereOrNull(
                                          (element) =>
                                              element['id'] ==
                                              widget.agency.villageId) !=
                                      null
                                  ? widget.agency.villageId
                                  : null,
                              name: 'village_id',
                ...
                onPressed: () async {
                  try {
                    if (_formKey.currentState!.saveAndValidate()) {
                      ...
                      AgencyModel? agency = await AgencyProvider.update(
                        widget.agency.uuid!,
                        data,
                      );
  ...
  Future<void> _getStaffs() async {
    try {
      ...
      if (_staffs.firstWhereOrNull(
              (element) => element['value'] == widget.agency.staffId) ==
          null) {

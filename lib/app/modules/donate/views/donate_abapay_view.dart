...
class DonateABAPayView extends StatefulWidget {
  final DonationModel donation;

  const DonateABAPayView({super.key, required this.donation});

  @override
  State<DonateABAPayView> createState() => _DonateABAPayViewState();
}

class _DonateABAPayViewState extends State<DonateABAPayView> {
              ...
              if (snapshot.hasData) {
                return InAppWebView(
                  ...
                  initialUrlRequest: URLRequest(
                    url: WebUri('${ApiService.baseUrl}insurance/payway/donate?payment_method_code=abapay&donation_uuid=${widget.donation.uuid}'),
                    headers: {
